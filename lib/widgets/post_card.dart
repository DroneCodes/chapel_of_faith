...
import 'package:chapel_of_faith/widgets/like_animation.dart';
...
import '../screens/popup_screens/comments_screen.dart';
...
class _PostCardState extends State<PostCard> {
  ...
  // calling an iniState function to get comment lengths
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // The Container for the number and Caption
          Container(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                DefaultTextStyle(style: Theme.of(context).textTheme.subtitle2!.copyWith(fontWeight: FontWeight.w800,), child: Text(
